...
Public Function Connection_DB() As Boolean
    ...
    #If SqlServer_ Then
        ...
        'SQL 2005
        'strConn = "Provider=SQLNCLI.1;Password=password;Persist Security Info=True;User ID=sa;Initial Catalog=KalaClubSQL;Data Source=gsportium"
        strConn = "Provider=SQLNCLI.1;Password=kala1228;Persist Security Info=True;User ID=sa;Initial Catalog=KalaClubSQL;Data Source=dell-gpo"
